...
class Establecimiento extends \FactelBundle\Entity\Establecimiento implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'emisor', 'ptosEmision', 'facturas', 'notasCredito', 'notasDebito', 'retencion', 'guias', 'nombre', 'codigo', 'urlweb', 'nombreComercial', 'direccion', 'activo', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy'];
        }
