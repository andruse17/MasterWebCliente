...
/* FactelBundle:ImpuestoICE:index.html.twig */
class __TwigTemplate_ff3aeb0e93695a5762abcba4bccb1837a269e4553e0b818d74d42149fa3a29c8 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("FactelBundle::Layout.html.twig", "FactelBundle:ImpuestoICE:index.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    {
        // line 9
        echo "<i class=\"fa fa-bar-chart-o fa-fw\"></i> Impuestos ICE
<div class=\"pull-right\">
    <a href=\"";
        // line 11
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("impuesto_ice_new");
        echo "\">
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "</td>
                <td>
                     <a href=\"";
            // line 36
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("impuesto_ice_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\" title=\"Editar\">
                        <button class=\"btn btn-primary link-boton\">
    ...
    {
        return "FactelBundle:ImpuestoICE:index.html.twig";
    }
    ...
    {
        return array (  122 => 49,  112 => 45,  106 => 42,  97 => 36,  92 => 34,  88 => 33,  85 => 32,  81 => 31,  69 => 21,  66 => 20,  54 => 11,  50 => 9,  47 => 8,  41 => 6,  36 => 4,  33 => 3,  30 => 2,  11 => 1,);
    }
...
{% endblock %}
{% block panel_title %}
<i class=\"fa fa-bar-chart-o fa-fw\"></i> Impuestos ICE
<div class=\"pull-right\">
    <a href=\"{{ path('impuesto_ice_new') }}\">
        <button class=\"btn btn-primary link-boton\">
            <i class=\"fa fa-plus-circle\"></i>
            Nuevo
        </button>
...
<div class=\"dataTable_wrapper table-responsive col-lg-12\">  
    <table class=\"table table-striped table-bordered table-hover\" id=\"data-table\">
        ...
        {% for entity in entities %}
            <tr>
                ...
                <td>
                     <a href=\"{{ path('impuesto_ice_edit', { 'id': entity.id }) }}\" title=\"Editar\">
                        <button class=\"btn btn-primary link-boton\">
                            <i class=\"fa fa-pencil-square-o\"></i>
                        </button>
                    </a>
    ...
    {% endblock %}
", "FactelBundle:ImpuestoICE:index.html.twig", "C:\\xampp\\htdocs\\FactelWebCliente\\src\\FactelBundle/Resources/views/ImpuestoICE/index.html.twig");
    }
}
