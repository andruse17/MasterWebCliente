...
class __TwigTemplate_078bb0b3b2b30cb75cc525ce843344e85697c7eb5660b63f7096c7ca9181dfca extends Twig_Template
{
...
{% endblock %}
{% block panel_title %}
<i class=\"fa fa-bar-chart-o fa-fw\"></i> Facturas
<div class=\"pull-right\">
    <a href=\"{{ path('notacredito_new') }}\">
        <button class=\"btn btn-primary link-boton\">
            <i class=\"fa fa-plus-circle\"></i>
            Nueva
        </button>
...
<script>
    var oTable = \$(\"#notaCredito-table\").dataTable({
        ...
        responsive: true,
        bAutoWidth: false,
        sAjaxSource: \"{{ path('all_notasCredito')}}\",
        bProcessing: true,
        bServerSide: true,
        bSort: false,
        aLengthMenu: [[5, 10, 15], [5, 10, 15]],
    ...
    {% endblock %}", "FactelBundle:NotaCredito:index.html.twig", "C:\\xampp\\htdocs\\FactelWebCliente\\src\\FactelBundle/Resources/views/NotaCredito/index.html.twig");
    }
}
